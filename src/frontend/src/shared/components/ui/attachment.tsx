...
function AttachmentGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex w-full max-w-full min-h-0 max-h-36 min-w-0 flex-wrap content-start gap-3 overflow-y-auto overscroll-y-contain py-1 *:data-[slot=attachment]:max-w-full",
        className
      )}
      {...props}
    />
