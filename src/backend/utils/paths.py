...
def author_scene_dir() -> str:
    return os.path.join(active_novel_dir(), "assets", "author_scenes")


def author_scene_path(filename: str) -> str:
    return os.path.join(author_scene_dir(), filename)
